...
public class TransactionService {
   ...
   public final Transaction createTransaction(TransactionDTO transaction) throws Exception {
...
//      }
   ...
   public final boolean authorizeTransaction(User sender, BigDecimal value) {
      String mock = "https://util.devi.tools/api/v2/authorize";

      ResponseEntity<Map> authorizationResponse = this.restTemplate.getForEntity(mock, Map.class);
